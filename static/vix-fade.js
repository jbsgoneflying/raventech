...
(function () {
  ...
  /* ════════════════════════════════════════════════════════════════════
     GPT-5.5 Contextual Desk Insight System
     ════════════════════════════════════════════════════════════════════ */
  ...
  function requestInsight(type, key, data, title) {
    ...
    $("e12PopupTitle").textContent = title || "Desk Insight \u2014 GPT-5.5";
  ...
  document.addEventListener("click", function (e) {
    ...
    if (sectionBtn && lastPayload) {
      ...
      if (section === "regime") {
        ...
        title = "Regime Dashboard \u2014 GPT-5.5";
      } else if (section === "edge") {
        sectionData = lastPayload.edgeComposite;
        title = "Edge Decomposition \u2014 GPT-5.5";
        ...
        title = "Scenario Analysis \u2014 GPT-5.5";
  ...
  function renderEdges(d) {
    ...
    for (var i = 0; i < edges.length; i++) {
      var e = edges[i];
      var btn = inlineInsightBtn("edge", e.edgeId || e.label, e, e.label + " \u2014 GPT-5.5");
      h += card(e.label,
