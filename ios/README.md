...
2) Quit Xcode.
3) Put the scaffold sources inside the Xcode app folder so Xcode can see them:
   - Xcode project folder: `ios/Raven-Tech iOS App/`
   - App sources live here: `ios/Raven-Tech iOS App/Raven-Tech iOS App/BreachApp/Sources/`
